                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                    <div>
                        ...
                        <div class="flex-col gap-4">
                            <a class="gap-1 flex cursor-pointer items-center hover:bg-red-600 justify-start p-2 rounded-sm group" href="/tools/tax-returns/income-statement"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 640 512" class="text-red-600 group-hover:text-white" height="24" width="24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="flex-col gap-4">
                            <a class="gap-1 flex cursor-pointer items-center hover:bg-blue-600 justify-start p-2 rounded-sm group" href="/tools/tax-returns/balance-sheet"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="text-blue-600 group-hover:text-white" height="24" width="24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        ...
                        <div class="flex-col gap-4">
                            <a class="gap-1 flex cursor-pointer items-center hover:bg-blue-600 justify-start p-2 rounded-sm group" href="/tools/financial-statements/balance-statements"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="text-blue-600 group-hover:text-white" height="24" width="24" xmlns="http://www.w3.org/2000/svg">
                                    <path fill="none" d="M0 0h24v24H0z"></path>
                                    <path fill="none" d="M0 0h24v24H0zm0 0h24v24H0zm21 19c0 1.1-.9 2-2 2H5c-1.1 0-2-.9-2-2V5c0-1.1.9-2 2-2h14c1.1 0 2 .9 2 2"></path>
                                    <path d="M21 5v6.59l-3-3.01-4 4.01-4-4-4 4-3-3.01V5c0-1.1.9-2 2-2h14c1.1 0 2 .9 2 2zm-3 6.42l3 3.01V19c0 1.1-.9 2-2 2H5c-1.1 0-2-.9-2-2v-6.58l3 2.99 4-4 4 4 4-3.99z"></path>
                                </svg>
