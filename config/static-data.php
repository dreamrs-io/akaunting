            ...
            'tools' => [
                [
                    ...
                    'page'  => [
                        ...
                        'whyChooseUs' => [
                            'h2' => 'Why Choose Us: Convert Income Statement to Tax Returns',
                            'h3' => 'Unravel the efficiency of Pocket CFO',
                ...
                [
                    'name' => 'Balance Sheet',
                    'icon'  => '<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 640 512" class="text-red-600 group-hover:text-white" height="24" width="24" xmlns="http://www.w3.org/2000/svg">
